...
```bash
cd /workspaces/fullerstack-humainary/fullerstack-substrates && ./jmh.sh CircuitOps 2>&1 | tee /workspaces/fullerstack-humainary/benchmark-results/circuitops-latest.txt
```
