...
/workspaces/fullerstack-humainary/substrates-api-java/jmh.sh CircuitOps 2>&1 | tee /workspaces/fullerstack-humainary/benchmark-results/circuitops-latest.txt
```
