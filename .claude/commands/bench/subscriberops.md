...
```bash
cd /workspaces/fullerstack-humainary/fullerstack-substrates && ./jmh.sh SubscriberOps 2>&1 | tee /workspaces/fullerstack-humainary/benchmark-results/subscriberops-latest.txt
```
