...
/workspaces/fullerstack-humainary/substrates-api-java/jmh.sh SubscriberOps 2>&1 | tee /workspaces/fullerstack-humainary/benchmark-results/subscriberops-latest.txt
```
