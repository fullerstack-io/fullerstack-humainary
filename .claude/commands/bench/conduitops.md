...
/workspaces/fullerstack-humainary/substrates-api-java/jmh.sh ConduitOps 2>&1 | tee /workspaces/fullerstack-humainary/benchmark-results/conduitops-latest.txt
```
