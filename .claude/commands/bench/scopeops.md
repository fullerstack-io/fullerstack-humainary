...
```bash
cd /workspaces/fullerstack-humainary/fullerstack-substrates && ./jmh.sh ScopeOps 2>&1 | tee /workspaces/fullerstack-humainary/benchmark-results/scopeops-latest.txt
```
