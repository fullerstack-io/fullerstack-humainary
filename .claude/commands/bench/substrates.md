...
/workspaces/fullerstack-humainary/substrates-api-java/jmh.sh io.humainary.substrates.jmh 2>&1 | tee /workspaces/fullerstack-humainary/benchmark-results/substrates-latest.txt
```
