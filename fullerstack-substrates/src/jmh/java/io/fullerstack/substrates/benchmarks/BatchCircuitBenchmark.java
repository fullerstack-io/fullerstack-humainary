...
/**
 * Benchmark for FsBatchCircuit implementation.
 *
 * <p>Tests the thread-local batching circuit that amortizes synchronization costs.
 */
...
public class BatchCircuitBenchmark {
  ...
  public void setupIteration() {
    ...
    circuit = new FsBatchCircuit(subject);
