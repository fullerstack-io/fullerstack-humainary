 ...
 *
 * <p>The @Temporal annotation indicates a type that is transient and whose reference should NOT be
 * retained. This means:
 *
 * <ul>
 *   <li>The object is only valid during the callback scope in which it's provided
 *   <li>Storing references to @Temporal objects for later use is undefined behavior
 *   <li>The implementation may reuse or invalidate the object after the callback returns
 * </ul>
 *
 * <p>@Temporal types in Substrates API include:
 *
 * <ul>
 ...
 * </ul>
 *
 * <p>These tests verify that @Temporal objects are properly usable within their callback scope.
 * Note: We cannot directly test that stored references become invalid (that would be testing
