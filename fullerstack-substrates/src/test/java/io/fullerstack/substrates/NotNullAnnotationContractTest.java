 ...
 *
 * <p>The @NotNull annotation indicates:
 *
 * <ul>
 ...
 *   <li>Methods throw NullPointerException when @NotNull parameters are passed null
 * </ul>
 */
...
class NotNullAnnotationContractTest {
  ...
  class NotNullReturnValues {
    ...
    void nameExtension_returnsNonNull() {
      ...
      assertNotNull(
          parent.name(cortex().name("child")), "name.name(suffix) must return non-null");
    }
    ...
    void stateExtension_returnsNonNull() {
      ...
      assertNotNull(
          state.state(cortex().name("key"), 42), "state.state(name, value) must return non-null");
    }
  ...
  class NotNullParameters {
    ...
    void circuitPipe_nullThrowsNPE() {
      assertThrows(
          NullPointerException.class,
          () -> circuit.pipe((Receptor<Object>) null),
    ...
    void circuitConduit_nullComposerThrowsNPE() {
      assertThrows(
          NullPointerException.class,
          () -> circuit.conduit(cortex().name("conduit"), null),
    ...
    void circuitSubscriber_nullNameThrowsNPE() {
      assertThrows(
          NullPointerException.class,
          () -> circuit.subscriber(null, (subject, registrar) -> {}),
    ...
    void circuitSubscriber_nullCallbackThrowsNPE() {
      assertThrows(
          NullPointerException.class,
          () -> circuit.subscriber(cortex().name("sub"), null),
    ...
    void stateExtension_nullStringValueThrowsNPE() {
      ...
      assertThrows(
          NullPointerException.class,
          () -> state.state(cortex().name("key"), (String) null),
  ...
  class ConduitNotNullContracts {
    ...
    void conduitPercept_returnsNonNull() {
      Conduit<Pipe<String>, String> conduit =
          circuit.conduit(cortex().name("conduit"), Composer.pipe());
      assertNotNull(
          conduit.percept(cortex().name("pipe")), "conduit.percept(name) must return non-null");
    }
  }
  ...
  class StateNotNullContracts {
    ...
    void stateStateName_nullValueThrowsNPE() {
      ...
      assertThrows(
          NullPointerException.class,
          () -> state.state(cortex().name("key"), (Name) null),
    ...
    void stateStateState_nullValueThrowsNPE() {
      ...
      assertThrows(
          NullPointerException.class,
          () -> state.state(cortex().name("key"), (State) null),
  ...
  class CellNotNullContracts {
    ...
    void circuitCell_nullIngressThrowsNPE() {
      assertThrows(
          ...
          () ->
              circuit.cell(
                  cortex().name("cell"), null, Composer.pipe(), (Receptor<Integer>) v -> {}),
    ...
    void circuitCell_nullEgressThrowsNPE() {
      assertThrows(
          ...
          () ->
              circuit.cell(
                  cortex().name("cell"), Composer.pipe(), null, (Receptor<Integer>) v -> {}),
