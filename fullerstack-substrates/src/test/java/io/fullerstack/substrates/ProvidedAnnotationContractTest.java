 ...
 *
 * <p>
 * The @Provided annotation indicates a type that is exclusively provided by the
 * runtime. This means:
 *
 * <ul>
 * <li>Users cannot directly implement these interfaces
 * <li>Instances are created only through factory methods (cortex(), circuit(),
 * etc.)
 ...
 * <p>
 * 
 * @Provided types in Substrates API include:
 *
 *           <ul>
 ...
 *
 *           <p>
 *           These tests verify that @Provided types:
 *
 *           <ul>
